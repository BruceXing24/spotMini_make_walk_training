...
class MotorControl(Node):
    def __init__(self,name):
        ...
        self.motor_num = 12
        self.hip_limit = [-61,  60]
        self.uLed_limit = [ -90, 90]
        self.lLed_limit = [-121, 121]
        self.motor_wise = [1, 0, 0, 1, 1, 1, 1, 0, 0, 1, 1, 1]
        self.res = 1000. / 240.
        # self.control_fre = 1. / 50 * 1000  # unit ms
        self.control_fre = 10 # unit ms
        self.angle_error=[0,10,25, 20,0,0, -20,-20,25, 30,-25,0]
        self.create_subscription(MotorAngles,'/angles_on_motor',self.sub_callback,1)
    ...
    def sub_callback(self,angles:MotorAngles):
        sub_angles = angles.angles
        #print(f'sub_angles==={sub_angles}')
        #print(type(sub_angles))
        self.control_motors(sub_angles)
...
def main():
    rclpy.init()
    controller = MotorControl("rasp_pose_controller")
