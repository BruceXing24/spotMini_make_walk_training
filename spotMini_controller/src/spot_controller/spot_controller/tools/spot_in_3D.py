...
# while True:
#     matrix_ABs = pose.get_AB(0,angle,0).T
#     x1, y1 ,z1 = matrix_ABs[0,0],matrix_ABs[0,1],matrix_ABs[0,2]
#     A1 = (B1[0]-x1,B1[1]-y1, B1[2]-z1)

#     ax.plot([ B1[0],A1[0] ],[ B1[1],A1[1] ],[ B1[2],A1[2] ],c='r')
...
#     ax.plot([ B2[0],A2[0] ],[ B2[1],A2[1] ],[ B2[2],A2[2] ],c='r')

#     x3, y3 ,z3 = matrix_ABs[2,0],matrix_ABs[2,1],matrix_ABs[2,2] #theta6, theta4,theta5
#     A3 = (B3[0]-x3,B3[1]-y3, B3[2]-z3)

#     ax.plot([ B3[0],A3[0] ],[ B3[1],A3[1] ],[ B3[2],A3[2] ],c='r')
...
#     ax.plot([ B4[0],A4[0] ],[ B4[1],A4[1] ],[ B4[2],A4[2] ],c='r')


#     ax.plot([ A1[0],A2[0] ],[ A1[1],A2[1]  ],[ A1[2],A2[2]  ],c='b')
#     ax.plot([ A2[0],A4[0] ],[ A2[1],A4[1]  ],[ A2[2],A4[2]  ],c='b')
#     ax.plot([ A3[0],A4[0] ],[ A3[1],A4[1]  ],[ A3[2],A4[2]  ],c='b')
#     ax.plot([ A3[0],A1[0] ],[ A3[1],A1[1]  ],[ A3[2],A1[2]  ],c='b')
#     angle +=a
